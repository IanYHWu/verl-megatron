...
from projects.reasoning_cache.rollouts import ReasoningCacheRolloutGenerator, load_score_function
from projects.reasoning_cache.advantage import compute_advantage as compute_advantage_reasoning_cache
from projects.reasoning_cache.metrics import compute_data_metrics as compute_data_metrics_reasoning_cache
...
class RayPPOTrainer:
    ...
    def __init__(
        ...
        # Load the scoring function for direct (response, label) -> float scoring
        # This is separate from reward_fn which is an AbstractRewardManager
        self.score_fn = load_score_function(self.config)
            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        batch = compute_advantage_reasoning_cache(batch)                    
                ...
                # collect metrics
                metrics.update(compute_data_metrics_reasoning_cache(batch=batch, config=self.config))
